 ...
 --}}
    ...
    <script>
        ...
        document.getElementById("btn-subj").onclick = function() {
            ...
            // alert(subjs)
            // let longSubj = perSubj.split(",")
            // i = i + 1
            // for (let i = 0; i < perSubj.length; i++) {
            //     document.getElementById("removeSubj" + i + "").onclick = function() {
